...
const nextConfig: NextConfig = {
  ...
  allowedDevOrigins: [
    ...
    '9000-firebase-studio-1749143369985.cluster-f4iwdviaqvc2ct6pgytzw4xqy4.cloudworkstations.dev',
    '6000-firebase-studio-1749143369985.cluster-f4iwdviaqvc2ct6pgytzw4xqy4.cloudworkstations.dev'
  ],
};
